...
let GoogleLoginController = class GoogleLoginController {
    ...
    async postLoginViaGoogle(clientCreds) {
        //do nothing
    }
    async googleCallback(code, state, response, user) {
...
tslib_1.__decorate([
    ...
    (0, loopback4_authentication_1.authenticate)("Google Oauth 2.0" /* STRATEGY.GOOGLE_OAUTH2 */, {
        accessType: 'offline',
        scope: ['profile', 'email'],
...
], GoogleLoginController.prototype, "loginViaGoogle", null);
tslib_1.__decorate([
    (0, loopback4_authentication_1.authenticateClient)("client-password" /* STRATEGY.CLIENT_PASSWORD */),
    (0, loopback4_authentication_1.authenticate)("Google Oauth 2.0" /* STRATEGY.GOOGLE_OAUTH2 */, {
        accessType: 'offline',
    ...
    tslib_1.__metadata("design:returntype", Promise)
], GoogleLoginController.prototype, "postLoginViaGoogle", null);
tslib_1.__decorate([
    (0, loopback4_authentication_1.authenticate)("Google Oauth 2.0" /* STRATEGY.GOOGLE_OAUTH2 */, {
        accessType: 'offline',
        scope: ['profile', 'email'],
    ...
    (0, loopback4_authorization_1.authorize)({ permissions: ['*'] }),
    (0, rest_1.get)('/auth/google-auth-redirect', {
        responses: {
            [200 /* STATUS_CODE.OK */]: {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], GoogleLoginController.prototype, "googleCallback", null);
GoogleLoginController = tslib_1.__decorate([
