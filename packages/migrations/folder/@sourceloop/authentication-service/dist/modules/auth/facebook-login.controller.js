...
exports.FacebookLoginController = void 0;
...
let FacebookLoginController = class FacebookLoginController {
    constructor(authClientRepository, logger, getAuthCode) {
        this.authClientRepository = authClientRepository;
        this.logger = logger;
        this.getAuthCode = getAuthCode;
    }
    async postLoginViaFacebook(clientCreds) {
        //do nothing
    }
    async facebookCallback(code, state, response, user) {
...
tslib_1.__decorate([
    ...
    (0, loopback4_authentication_1.authenticate)("Facebook Oauth 2.0" /* STRATEGY.FACEBOOK_OAUTH2 */, {
        accessType: 'offline',
...
], FacebookLoginController.prototype, "postLoginViaFacebook", null);
tslib_1.__decorate([
    (0, loopback4_authentication_1.authenticate)("Facebook Oauth 2.0" /* STRATEGY.FACEBOOK_OAUTH2 */, {
        accessType: 'offline',
        authorizationURL: process.env.FACEBOOK_AUTH_URL,
    ...
    (0, loopback4_authorization_1.authorize)({ permissions: ['*'] }),
    (0, rest_1.get)('/auth/facebook-auth-redirect', {
        responses: {
            [200 /* STATUS_CODE.OK */]: {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], FacebookLoginController.prototype, "facebookCallback", null);
FacebookLoginController = tslib_1.__decorate([
...
//# sourceMappingURL=facebook-login.controller.js.map