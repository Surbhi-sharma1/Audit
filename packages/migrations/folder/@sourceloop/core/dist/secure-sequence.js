...
let SecureSequence = class SecureSequence {
    constructor(
    // sonarignore:start
    findRoute, parseParams, invoke, send, reject, logger, authenticateRequest, authenticateClientRequest, checkAuthorisation, helmetAction, rateLimitAction, i18n, // sonarignore:end
...
], SecureSequence.prototype, "invokeMiddleware", void 0);
tslib_1.__decorate([
    (0, context_1.inject)(keys_1.SFCoreBindings.EXPRESS_MIDDLEWARES, { optional: true }),
    tslib_1.__metadata("design:type", Array)
], SecureSequence.prototype, "expressMiddlewares", void 0);
SecureSequence = tslib_1.__decorate([
    ...
    tslib_1.__param(8, (0, context_1.inject)(loopback4_authorization_1.AuthorizationBindings.AUTHORIZE_ACTION)),
    tslib_1.__param(9, (0, context_1.inject)(loopback4_helmet_1.HelmetSecurityBindings.HELMET_SECURITY_ACTION)),
    tslib_1.__param(10, (0, context_1.inject)(loopback4_ratelimiter_1.RateLimitSecurityBindings.RATELIMIT_SECURITY_ACTION)),
    tslib_1.__param(11, (0, context_1.inject)(keys_1.SFCoreBindings.i18n)),
    tslib_1.__param(12, (0, context_1.inject)(loopback4_ratelimiter_1.RateLimitSecurityBindings.CONFIG, { optional: true })),
    tslib_1.__param(13, (0, context_1.inject)(loopback4_helmet_1.HelmetSecurityBindings.CONFIG, { optional: true })),
    tslib_1.__metadata("design:paramtypes", [Function, Function, Function, Function, Function, Object, Function, Function, Function, Function, Function, Object, Object, Object])
], SecureSequence);
exports.SecureSequence = SecureSequence;
//# sourceMappingURL=secure-sequence.js.map