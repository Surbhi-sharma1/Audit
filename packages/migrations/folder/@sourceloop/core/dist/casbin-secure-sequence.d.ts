...
export declare class CasbinSecureSequence implements SequenceHandler {
    ...
    constructor(findRoute: FindRoute, parseParams: ParseParams, invoke: InvokeMethod, send: Send, reject: Reject, logger: ILogger, authenticateRequest: AuthenticateFn<IAuthUserWithPermissions>, authenticateClientRequest: AuthenticateFn<IAuthClient>, checkAuthorisation: CasbinAuthorizeFn, casbinResModifierFn: CasbinResourceModifierFn, helmetAction: HelmetAction, rateLimitAction: RateLimitAction, i18n: i18nAPI, // sonarignore:end
