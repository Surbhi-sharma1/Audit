...
exports.ServiceSequence = void 0;
...
let ServiceSequence = class ServiceSequence {
    constructor(
    // sonarignore:start
    findRoute, parseParams, invoke, send, reject, logger, authenticateRequest, checkAuthorisation, i18n) {
...
], ServiceSequence.prototype, "invokeMiddleware", void 0);
tslib_1.__decorate([
    (0, context_1.inject)(keys_1.SFCoreBindings.EXPRESS_MIDDLEWARES, { optional: true }),
    tslib_1.__metadata("design:type", Array)
], ServiceSequence.prototype, "expressMiddlewares", void 0);
ServiceSequence = tslib_1.__decorate([
    ...
    tslib_1.__param(8, (0, context_1.inject)(keys_1.SFCoreBindings.i18n)),
    tslib_1.__metadata("design:paramtypes", [Function, Function, Function, Function, Function, Object, Function, Function, Object])
], ServiceSequence);
exports.ServiceSequence = ServiceSequence;
//# sourceMappingURL=service-sequence.js.map